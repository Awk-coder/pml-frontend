          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between">
              <div className="text-sm">
                <Link to="/auth/reset-password" className="font-medium text-blue-400 hover:text-blue-300">
          ...
          <div className="mt-8">
            ...
            <div className="mt-6">
              <Link
                ...
                className="w-full flex justify-center items-center py-2 px-4 border border-green-500 rounded-md shadow-sm text-sm font-medium text-green-400 bg-transparent hover:bg-green-500/10 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
              >
                Become a Recruitment Agent <FiArrowRight className="ml-2" />
              </Link>
            </div>
          </div>
        </div>
