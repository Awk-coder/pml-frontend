        ...
        <div className="container mx-auto px-6 relative z-20">
          ...
          <div className="mb-12">
            <h1 className="font-orbitron text-4xl font-bold text-white mb-4">
              Welcome, <span className="text-blue-400">{user?.universityName}</span>
            </h1>
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-gray-900/50">
                  <tr>
                    <th className="text-left p-4 font-space text-gray-400">Student</th>
                    <th className="text-left p-4 font-space text-gray-400">Program</th>
                    <th className="text-left p-4 font-space text-gray-400">Submitted</th>
