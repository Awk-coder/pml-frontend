          ...
          <div className="mt-8">
            ...
            <div className="mt-6">
              <Link
                ...
                className="w-full flex justify-center items-center py-2 px-4 border border-blue-500 rounded-md shadow-sm text-sm font-medium text-blue-400 bg-transparent hover:bg-blue-500/10 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
              >
                Create Student Account <FiArrowRight className="ml-2" />
              </Link>
            </div>
          </div>
        </div>
